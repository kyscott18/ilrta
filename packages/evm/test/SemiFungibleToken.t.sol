...
//     bytes32 private constant VERIFY_TYPEHASH = keccak256("Verify(bytes32[] dataHash,uint256 nonce,uint256
// deadline)");
...
// deadline)TransferDetails(uint256 id,uint256 amount)"
//         )
//     );

//     bytes32 private constant TRANSFER_DETAILS_TYPEHASH = keccak256(bytes("TransferDetails(uint256 id,uint256
// amount)"));
...
//         assertTrue(
//             sft.transfer(
//                 address(0xC0FFEE), ILRTASemiFungibleToken.ILRTATransferDetails({amount: 1e18, id:
// bytes32(uint256(69))})
//             )
//         );

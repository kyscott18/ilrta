...
contract Permit3Test is Test {
    ...
    function testTransferBySignature() external {
        ...
        Permit3.TransferDetails memory transferDetails =
            Permit3.TransferDetails(address(mockERC20), Permit3.TokenType.ERC20, 0x23b872dd, abi.encode(1e18));
        ...
        permit3.transferBySignature(
            ...
            Permit3.RequestedTransferDetails(address(this), abi.encode(1e18)),
            signature
        );
    }
